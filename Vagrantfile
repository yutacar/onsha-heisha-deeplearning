...
echo -e "Downloading Anaconda installer. This may take more than a few minutes."
wget -q -o /dev/null - https://repo.continuum.io/archive/Anaconda3-4.2.0-Linux-x86_64.sh
if [ -s $anaconda ]
then
  chmod +x $anaconda
